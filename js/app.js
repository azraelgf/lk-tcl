    ...
    class Popup {
        ...
        open(selectorValue) {
            if (bodyLockStatus) {
                ...
                const loadingEl = this.targetOpen.element.querySelector(".product-popup__loading");
                if (loadingEl) {
                    loadingEl.classList.remove("_hide");
                    loadingEl.classList.add("loading_start");
                    setTimeout((() => this._removeLoading(loadingEl)), 2e3);
                }
                this.options.on.afterOpen(this);
                document.dispatchEvent(new CustomEvent("afterPopupOpen", {
                    detail: {
        ...
        _removeLoading=el => {
            if (el) {
                el.classList.remove("loading_start");
        ...
        _applyValueSkeleton() {
            const values = this.targetOpen.element?.querySelectorAll(".info-product-popup__value");
